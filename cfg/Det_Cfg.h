 ...
 * application-dependent and should be generated by a configuration tool. For the 
 * moment,the files shall be written manually by the user according to their 
 * application. Also, the user is responsible for setting the parameter in the 
 * right way.
 */
#ifndef DET_CFG_H__
#define DET_CFG_H__
