...
#define ADC_RESULT_BUFFER                 0x01u /*!< Adc_SetupResultBuffer() api service id */
#define ADC_ID_DE_INIT                    0x02u /*!< Adc_DeInit() api service id */
#define ADC_START_GROUP_CONVERSION        0x03u /*!< Adc_StartGroupConversion() api service id */
#define ADC_STOP_GROUP_CONVERSION         0x04u /*!< Adc_StopGroupConversion() api service id */
#define ADC_READ_GROUP                    0x05u /*!< Adc_ReadGroup() api service id */
#define ADC_ENABLE_HARDWARE_TRIGGER       0x06u /*!< Adc_EnableHardwareTrigger() api service id */
#define ADC_DISABLE_HARDWARE_TRIGGER      0x07u /*!< Adc_DisableHardwareTrigger() api service id */
#define ADC_ENABLE_GROUP_NOTIFICATION     0x08u /*!< Adc_EnableGroupNotification() api service id */
#define ADC_DISABLE_GROUP_NOTIFICATION    0x09u /*!< Adc_DisableGroupNotification() api service id*/
#define ADC_GET_GROUP_STATUS              0x0Au /*!< Adc_GetGroupStatus() api service id */
#define ADC_GET_STREAM_LAST_POINTER       0x0Bu /*!< Adc_GetStreamLastPointer() api service id */
#define ADC_GET_VERSION_INFO              0x0Cu /*!< Adc_GetVersionInfo() api service id */
#define ADC_SET_POWER_STATE               0x0Du /*!< Adc_SetPowerState() api service id */
#define ADC_GET_CURRENT_POWER_STATE       0x0Eu /*!< Adc_GetCurrentPowerState() api service id */
#define ADC_GET_TARGET_POWER_STATE        0x0Fu /*!< Adc_GetTargetPowerState() api service id */
#define ADC_PREPARE_POWER_STATE           0x10u /*!< Adc_PreparePowerState() api service id */
#define ADC_MAIN_POWER_TRANSITION_MANAGER 0x11u /*!< Adc_Main_PowerTransitionManager api service id */
/**
 * @} */
 ...
 *
 * @{ */
#define ADC_E_UNINIT                      0x00u /*!< API is called prior to initialization. */
#define ADC_E_ALREADY_INITIALIZED         0x01u /*!< API called while ADC is already initialized.*/
#define ADC_E_PARAM_POINTER               0x02u /*!< API called with incorrect buffer pointer.*/
#define ADC_E_PARAM_GROUP                 0x03u /*!< API called with non existing group.*/
#define ADC_E_WRONG_CONV_MODE             0x04u /*!< API called for a group configured for \
                                                continuous conversion mode. */
#define ADC_E_WRONG_TRIGG_SRC             0x05u /*!< API call not allowed according group \
                                                configuration. */
#define ADC_E_NOTIF_CAPABILITY            0x06u /*!< API called and notification function pointer \
                                                is NULL. */
#define ADE_E_BUFFER_UNINIT               0x07u /*!< API called while result buffer pointer is not \
                                                initialized. */
#define ADE_E_POWER_STATE_NOT_SUPPORTED   0x08u /*!< API call with unsupported power state request.*/
#define ADC_E_PERIPHERAL_NOT_PREPARED     0x09u /*!< ADC not prepared for requested target power \
                                                state. */
#define ADC_E_BUSY                        0x0Au /*!< API is called while another conversion is      \
                                                already running, a HW trigger is already enabled, a \
                                                request is already stored in the queue. */
#define ADC_E_IDLE                        0x0Bu /*!< API is called while group is in state ADC_IDLE \
                                                or non enabled group. */
#define ADC_E_NOT_DISENGAGED              0x0Cu /*!< API called while one or more ADC groups are \
                                                not in IDLE state. */
#define ADC_E_TRANSITION_NOT_POSSIBLE     0x0Du /*!< Requested power state can not be reached.  */
/**
 * @} */
