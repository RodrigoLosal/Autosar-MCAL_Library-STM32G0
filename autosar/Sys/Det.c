...
static const char *FlsErrorNameRuntime[] =
{
    ...
    [FLS_E_VERIFY_WRITE_FAILED] = "FLS_E_VERIFY_WRITE_FAILED",
    [FLS_E_TIMEOUT]             = "FLS_E_TIMEOUT",
};
/* clang-format on */
...
static const char *FlsErrorNameTransient[] =
{
    ...
    [FLS_E_READ_FAILED]         = "FLS_E_READ_FAILED",
    [FLS_E_COMPARE_FAILED]      = "FLS_E_COMPARE_FAILED",
    [FLS_E_UNEXPECTED_FLASH_ID] = "FLS_E_UNEXPECTED_FLASH_ID",
};
/* clang-format on */
