/**
 * @file    Bfx_16bits.h
 * @brief   **This file contains the Bitfield functions for fixed point for 16 bit registers.**
 *
...
{
    *Data = ( *Data >> ShiftCnt ) | ( *Data << ( 16 - ShiftCnt ) );
}
 ...
 */
static inline uint8 Bfx_CountLeadingZeros_u16( uint16 Data )
{
    uint8 Counter = 0;
