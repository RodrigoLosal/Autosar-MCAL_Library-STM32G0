...
{
    uint8 Data = 0b10000001;
    Bfx_SetBitMask_u8u8( &Data, 0b01111100 );
...
{
    uint8 Data = 0b10000001;
    Bfx_SetBitMask_u8u8( &Data, 0b10000001 );
...
{
    uint8 Data = 0b10000001;
    Bfx_ClrBitMask_u8u8( &Data, 0b10000001 );
...
{
    uint8 Data = 0b10111001;
    Bfx_ClrBitMask_u8u8( &Data, 0b00101000 );
...
{
    uint8 Data     = 0b10010011;
    boolean Result = Bfx_TstBitMask_u8u8_u8( Data, 0b10010000 );
...
{
    uint8 Data     = 0b10010001;
    boolean Result = Bfx_TstBitMask_u8u8_u8( Data, 0b10010011 );
...
{
    uint8 Data     = 0b11001100;
    boolean Result = Bfx_TstBitLnMask_u8u8_u8( Data, 0b00110011 );
...
{
    uint8 Data     = 0b10001100;
    boolean Result = Bfx_TstBitLnMask_u8u8_u8( Data, 0b01000110 );
 ...
 *
 * The test validates the number of bits set to 1 in the value 1100 1000 is even resulting in a FALSE
 */
void test__TstParityEven_u8_u8__3bits( void )
{
    uint8 Data     = 0b11001000;
 ...
 *
 * The test validates the number of bits set to 1 in the value 1101 1101 is even resulting in a TRUE
 */
void test__TstParityEven_u8_u8__6bits( void )
{
    uint8 Data     = 0b11011101;
    boolean Result = Bfx_TstParityEven_u8_u8( Data );
...
{
    uint8 Data = 0b10011001;
    Bfx_ToggleBitMask_u8u8( &Data, 0b01100110 );
...
{
    uint8 Data = 0b10001000;
    Bfx_ToggleBitMask_u8u8( &Data, 0b01011000 );
...
{
    uint8 Data = 0b11111111u;
    Bfx_PutBit_u8u8u8( &Data, 7, 0 );
    TEST_ASSERT_EQUAL_HEX8_MESSAGE( Data, 0b01111111, "The bit wasnt put on the 7 position" );
}
...
{
    uint8 Data = 0b00000000u;
    Bfx_PutBit_u8u8u8( &Data, 6, 1 );
    TEST_ASSERT_EQUAL_HEX8_MESSAGE( Data, 0b01000000, "The bit wasnt put on the 6 position" );
}
